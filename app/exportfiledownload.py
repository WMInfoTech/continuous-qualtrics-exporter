...
def exportfiledownload(dataCenter, survey_id, file_id, bearerToken, downloadfile):
...
if __name__ == "__main__":
    ...
    try:
        ...
        if args.fileId is None or args.bearerToken is None:
            ...
            print(exportfiledownload(settings['QUALTRICS_DATACENTER'], settings['QUALTRICS_SURVEYID'], args.fileId, args.bearerToken, os.path.join(settings['QUALTRICS_UPLOADPATH'], settings['QUALTRICS_UPLOADFILE'])))
    except Exception as e:
